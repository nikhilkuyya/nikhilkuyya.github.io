...
var $author$project$Main$Section = F4(
	function (heading, caption, _class, data) {
		return {caption: caption, _class: _class, data: data, heading: heading};
	});
var $author$project$Main$TextString = function (a) {
	return {$: 'TextString', a: a};
};
...
var $author$project$Main$ListSectionData = function (a) {
	return {$: 'ListSectionData', a: a};
};
var $author$project$Main$ListTextString = function (a) {
	return {$: 'ListTextString', a: a};
};
var $author$project$Main$SectionData = function (a) {
	return {$: 'SectionData', a: a};
};
...
function $author$project$Main$cyclic$resumeSectionDecoder() {
	return A3(
		...
		'data',
		$author$project$Main$cyclic$resumeSectionDataDecoder(),
		A4(
...
function $author$project$Main$cyclic$resumeSectionDataDecoder() {
	return $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$map, $author$project$Main$TextString, $elm$json$Json$Decode$string),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$Main$ListTextString,
				$elm$json$Json$Decode$list($elm$json$Json$Decode$string)),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$Main$SectionData,
				$elm$json$Json$Decode$lazy(
					function (_v0) {
						return $author$project$Main$cyclic$resumeSectionDecoder();
					})),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$Main$ListSectionData,
...
try {
	var $author$project$Main$resumeSectionDecoder = $author$project$Main$cyclic$resumeSectionDecoder();
	$author$project$Main$cyclic$resumeSectionDecoder = function () {
		return $author$project$Main$resumeSectionDecoder;
	};
	var $author$project$Main$resumeSectionDataDecoder = $author$project$Main$cyclic$resumeSectionDataDecoder();
	$author$project$Main$cyclic$resumeSectionDataDecoder = function () {
		return $author$project$Main$resumeSectionDataDecoder;
	};
} catch ($) {
...
var $author$project$Main$runResumeModelDecoder = function (payload) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$resumeDataDecoder, payload);
	if (_v0.$ === 'Ok') {
		var resumeContent = _v0.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_List_Nil,
				$author$project$Main$resumeSectionDataView(section.data))
			]));
};
