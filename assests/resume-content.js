  ...
  },
  {
    ...
    data: {
      ...
      data: [
        ...
        {
          heading: "Junior Associate",
          caption: "Oct 2016 - Sep 2017",
          data: [
            {
              heading: "Explored diverse projects relating DOTNET Framework.",
              data: [
                "Implemented features like managing configuration files and databases to Windows Installer.",
                "United features to Excel Plugin to fetch workbook data.",
                "Worked on building and bug fixes for services in automation project."
              ]
            }
          ]
        }
